...
export class ProfilepicPage {
  ...
  defaultimgUrl = '../../assets/chatterplace.png';
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public imgservice: ImghandlerProvider,
    public zone: NgZone, public userservice: UserServiceProvider, public loadingCtrl: LoadingController) {
  }

  ionViewDidLoad() {
    this.userservice.updateimage(this.defaultimgUrl);
